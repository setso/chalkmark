 ...
 *
 */
public class DropBalloonOverlayView<Item extends OverlayItem> extends FrameLayout {
	 ...
	 */
	public DropBalloonOverlayView(Context context, int balloonBottomOffset) {
		...
		View v = inflater.inflate(R.layout.drop_balloon_overlay, layout);
