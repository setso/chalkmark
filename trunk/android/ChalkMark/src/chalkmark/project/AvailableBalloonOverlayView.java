 ...
 *
 */
public class AvailableBalloonOverlayView<Item extends OverlayItem> extends FrameLayout 
{
	 ...
	 */
	public AvailableBalloonOverlayView(Context context, int balloonBottomOffset) 
	{
		super(context);
